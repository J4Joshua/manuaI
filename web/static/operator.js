...
(function () {
  ...
  (function setupCamera() {
    ...
    if (pollMode) {
      // Offline glasses bridge relays the Ray-Ban camera as MJPEG. Probe the single-frame
      // endpoint for readiness, then point the visible <img> at the live MJPEG stream;
      // revert to the placeholder if the feed stops.
      if (video) video.style.display = "none";
      var feedOn = false;
